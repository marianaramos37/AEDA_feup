...
int main() {
    ...
    cout<<b.getFuncionariosTodos()[0]->getNome()<<endl;
    //mainmenu();
    return 0;
}
void mainmenu(){
...
void fazerEncomenda(Restaurante r,Cliente c){
    ...
    if(existe){
        ...
        cout<<"Meio de transporte utilizado: "<<f->getVeiculoAlocado().getMarca()<< ", "<<f->getVeiculoAlocado().getTipo()<< ", "<<f->getVeiculoAlocado().getDataDeAquisicao()<<endl;
        //Hora
                ...
                for(int i=0; i<c.getBase().getFuncionarios().size(); i++) {
                    if(c.getBase().getFuncionarios()[i]->getTipoDeFuncionario() == "Entregador") {
                        if (c.getBase().getFuncionarios()[i]->getNome() == e.getEntregadorNome()) {
                            //cout << c.getBase().getFuncionarios()[i]->isDisponivel() << endl;
                            c.getBase().getFuncionarios()[i]->setDisponivel(false);
                            //cout << c.getBase().getFuncionarios()[i]->isDisponivel() << endl;
                            break;
                        }
            ...
            if (op == '1') {
                ...
                if (pass == "0000") {
                    ...
                    do{
                        ...
                        cin >> op1;
                    }while(!isdigit(op1)||(op1!='1'&&op1!='2'&&op1!='3'));
                    switch (op1) {
                        case '1':
                            verFunc();
                            break;
    ...
    if (base == 1) {
        ...
        for (int i = 0; i < b.getFuncionarios().size(); i++) {
            if (b.getFuncionarios()[i]->getTipoDeFuncionario() == "Administrador") {
                ...
                cout << "    \tData de Aquisisao: " << b.getFuncionarios()[i]->getVeiculoAlocado().getDataDeAquisicao() << endl;
                ...
                cout << "    \tNr de entregas: " << b.getFuncionarios()[i]->getVeiculoAlocado().getNumEntregas() << endl;
                ...
                cout << "\t\t\tData de Nascimento: \t"
                     << to_string(b.getFuncionarios()[i]->getData().getDia()) + "/" +
                        ...
                        to_string(b.getFuncionarios()[i]->getData().getAno()) << endl;
                cout << "\t\t\tSalario: \t\t" << to_string(b.getFuncionarios()[i]->getSalario()) << endl;
                //cout << "\t\t\tDisponivel daqui a: \t" << to_string(b.getFuncionarios()[i]->getDisponibilidade()) << endl;
        ...
        for (int i = 0; i < c.getFuncionariosTodos().size(); i++) {
            ...
            if (!atual1) {
                cout << "\t\t\t\t\t\t" << "   " << c.getFuncionariosTodos()[i]->getNome() << " - "
                     << c.getFuncionariosTodos()[i]->getNif() << endl;
            } else {
                cout << "\t\t" << c.getFuncionariosTodos()[i]->getNome() << " - "
                     << c.getFuncionariosTodos()[i]->getNif() << endl;
            }
        ...
        for (int i = 0; i < d.getFuncionariosTodos().size(); i++) {
            ...
            if (!atual2) {
                cout << "\t\t\t\t\t\t" << "   " << d.getFuncionariosTodos()[i]->getNome() << " - "
                     << d.getFuncionariosTodos()[i]->getNif() << endl;
            } else {
                cout << "\t\t" << d.getFuncionariosTodos()[i]->getNome() << " - "
                     << d.getFuncionariosTodos()[i]->getNif() << endl;
            }
        }
        cout<<endl<<"Para ver listagem detalhada de cada funcionario selecione ver funcionarios da base pertendida"<<endl;
        /*cout << "   Funcionarios Porto   " << endl;
        cout << "_______________________" << endl;
        cout << endl;
        for (int i = 0; i < b.getFuncionarios().size(); i++) {
            if (b.getFuncionarios()[i]->getTipoDeFuncionario() == "Administrador") {
                cout << "Tipo de Funcionario: \t" << b.getFuncionarios()[i]->getTipoDeFuncionario() << endl;
                cout << "Nome: \t\t\t" << b.getFuncionarios()[i]->getNome() << endl;
                cout << "NIF: \t\t\t" << b.getFuncionarios()[i]->getNif() << endl;
                cout << "Data de Nascimento: \t"
                     << to_string(b.getFuncionarios()[i]->getData().getDia()) + "/" +
                ...
                cout << "Data de Nascimento: \t"
                     << to_string(b.getFuncionarios()[i]->getData().getDia()) + "/" +
                        ...
                        to_string(b.getFuncionarios()[i]->getData().getAno()) << endl;
                cout << "Salario: \t\t" << to_string(b.getFuncionarios()[i]->getSalario()) << endl;
                cout << "Veiculo Alocado: \t" << b.getFuncionarios()[i]->getVeiculoAlocado().getMarca() + ", " +
                                                 b.getFuncionarios()[i]->getVeiculoAlocado().getTipo() + ", " +
                                                 b.getFuncionarios()[i]->getVeiculoAlocado().getDataDeAquisicao()
                     << endl;
                if (b.getFuncionarios()[i]->isDisponivel()) {
                    cout << "Entregador disponivel" << endl;
                } else {
                    cout << "Entregador nao disponivel" << endl;
                }
        ...
        for (int i = 0; i < c.getFuncionarios().size(); i++) {
            if (c.getFuncionarios()[i]->getTipoDeFuncionario() == "Administrador") {
                cout << "Tipo de Funcionario: \t" << c.getFuncionarios()[i]->getTipoDeFuncionario() << endl;
                cout << "Nome: \t\t\t" << c.getFuncionarios()[i]->getNome() << endl;
                cout << "NIF: \t\t\t" << c.getFuncionarios()[i]->getNif() << endl;
                cout << "Data de Nascimento: \t"
                     << to_string(c.getFuncionarios()[i]->getData().getDia()) + "/" +
                        to_string(c.getFuncionarios()[i]->getData().getMes()) + "/" +
                        to_string(c.getFuncionarios()[i]->getData().getAno()) << endl;
                cout << "Salario: \t\t" << to_string(c.getFuncionarios()[i]->getSalario()) << endl;
                cout << "Funcao: \t\t" << c.getFuncionarios()[i]->getFuncao() << endl;
                cout << ":::::" << endl;
                ...
                cout << "Data de Nascimento: \t"
                     << to_string(c.getFuncionarios()[i]->getData().getDia()) + "/" +
                        ...
                        to_string(c.getFuncionarios()[i]->getData().getAno()) << endl;
                cout << "Salario: \t\t" << to_string(c.getFuncionarios()[i]->getSalario()) << endl;
                cout << "Veiculo Alocado: \t" << c.getFuncionarios()[i]->getVeiculoAlocado().getMarca() + ", " +
        ...
        for (int i = 0; i < d.getFuncionarios().size(); i++) {
            if (d.getFuncionarios()[i]->getTipoDeFuncionario() == "Administrador") {
                cout << "Tipo de Funcionario: \t" << d.getFuncionarios()[i]->getTipoDeFuncionario() << endl;
                cout << "Nome: \t\t\t" << d.getFuncionarios()[i]->getNome() << endl;
                cout << "NIF: \t\t\t" << d.getFuncionarios()[i]->getNif() << endl;
                cout << "Data de Nascimento: \t"
                     << to_string(d.getFuncionarios()[i]->getData().getDia()) + "/" +
                        to_string(d.getFuncionarios()[i]->getData().getMes()) + "/" +
                        to_string(d.getFuncionarios()[i]->getData().getAno()) << endl;
                cout << "Salario: \t\t" << to_string(d.getFuncionarios()[i]->getSalario()) << endl;
                cout << "Funcao: \t\t" << d.getFuncionarios()[i]->getFuncao() << endl;
                cout << ":::::" << endl;
                ...
                cout << "Data de Nascimento: \t"
                     << to_string(d.getFuncionarios()[i]->getData().getDia()) + "/" +
                        ...
                        to_string(d.getFuncionarios()[i]->getData().getAno()) << endl;
                cout << "Salario: \t\t" << to_string(d.getFuncionarios()[i]->getSalario()) << endl;
                cout << "Veiculo Alocado: \t" << d.getFuncionarios()[i]->getVeiculoAlocado().getMarca() + ", " +
