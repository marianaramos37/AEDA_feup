...
class Veiculo{
    ///\brief A marca do Veículo.
    string marca;
    ///\brief O tipo do Veículo.
    string tipo;
    ///\brief A data de aquisição em string  do Veículo.
    string data_de_aquisicao;
public:
    ///\brief Construtor da Classe Veiculo.
    Veiculo();
    ///\brief Constroi uma instância da classe Veiculo recebendo uma string estruturada com o seu conteudo.
    ///\param d: A string estruturada com o conteudo do Veículo.
    Veiculo(string v);
    ///\brief Destrutor da Classe Data.
    virtual ~Veiculo();
