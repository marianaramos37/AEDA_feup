...
void Base::setFuncionarios(const vector<Funcionario*> &funcionariosv){
    funcionarios=funcionariosv;
}
...
tabHFuncionario Base::getTab(){
    return funcionarios_tabH;
}
//______________readfiles______________________//
...
//______________manageclients__________________//
...
//______________manageRestaurant________________//
...
//______________manageFuncionarios_____________//
void Base::addAdmin(){
    Administrador a;
    Data d;
    ofstream file;
    ...
    cout<<" {9} - Adicionar novo funcionario" <<endl;
    int tab;
    cin>>tab;
    if(tab==9) {
        cin.clear();
...
void Base::addEntreg() {
    ...
    if(tab==9) {
        ...
        file << a.getVeiculoAlocado().getMarca() + " ," + a.getVeiculoAlocado().getTipo() + " ," +
                a.getVeiculoAlocado().getDataDeAquisicao() << endl;
        ...
        file << f->getVeiculoAlocado().getMarca() + " ," + f->getVeiculoAlocado().getTipo() + " ," +
                f->getVeiculoAlocado().getDataDeAquisicao() << endl;
