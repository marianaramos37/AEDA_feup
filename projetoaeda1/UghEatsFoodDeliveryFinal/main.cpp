    ...
    while(!exit) {
        ...
        if(!exit) {
            if (op == 1) {
                ...
                if (pass == "0000") {
                    //ver e mexer -adicionar/remover funcionarios
                    cout << "{1} - Adicionar funcionarios \n";
                    cout << "{2} - Remover funcionarios\n";
                    cout<< "Pirma {0} para voltar atras!\n";
                    int op1;
                    cin >> op1;
                    switch (op1) {
                        case 0:
    ...
    while (!exit) {
        ...
        if (base == 1) {
            ...
            for (int i = 0; i < b.getRestaurantes().size(); i++) {
                ...
                cout << b.getRestaurantes()[i].getNome() << endl;
                cout << b.getRestaurantes()[i].getMorada().getRua() << ", "
                     << b.getRestaurantes()[i].getMorada().getLocalidade() << ", "
                     << b.getRestaurantes()[i].getMorada().getNumero() << endl;
                cout << b.getRestaurantes()[i].getTiposDeCulinaria()[0] << endl;
                cout << "Menu:" << endl;
                for (int j = i; i < b.getRestaurantes()[i].getPratos().size(); j++) {
                    cout << b.getRestaurantes()[i].getPratos()[j].getNome() << " Preco: "
                         << b.getRestaurantes()[i].getPratos()[j].getPreco() << endl;
                }
            ...
            for (int i = 0; i < c.getRestaurantes().size(); i++) {
                ...
                cout << c.getRestaurantes()[i].getNome() << endl;
                cout << c.getRestaurantes()[i].getMorada().getRua() << ", "
                     << c.getRestaurantes()[i].getMorada().getLocalidade() << ", "
                     << c.getRestaurantes()[i].getMorada().getNumero() << endl;
                cout << c.getRestaurantes()[i].getTiposDeCulinaria()[0] << endl;
                cout << "Menu:" << endl;
                for (int j = i; i < c.getRestaurantes()[i].getPratos().size(); j++) {
                    cout << c.getRestaurantes()[i].getPratos()[j].getNome() << " Preco: "
                         << c.getRestaurantes()[i].getPratos()[j].getPreco() << endl;
                }
            ...
            for (int i = 0; i < d.getRestaurantes().size(); i++) {
                ...
                cout << d.getRestaurantes()[i].getNome() << endl;
                cout << d.getRestaurantes()[i].getMorada().getRua() << ", "
                     << d.getRestaurantes()[i].getMorada().getLocalidade() << ", "
                     << d.getRestaurantes()[i].getMorada().getNumero() << endl;
                cout << d.getRestaurantes()[i].getTiposDeCulinaria()[0] << endl;
                cout << "Menu:" << endl;
                for (int j = i; i < d.getRestaurantes()[i].getPratos().size(); j++) {
                    cout << d.getRestaurantes()[i].getPratos()[j].getNome() << " Preco: "
                         << b.getRestaurantes()[i].getPratos()[j].getPreco() << endl;
                }
...
void verClientes(){
    ...
    while(!exit) {
        ...
        if (base == 1) {
            ...
            cout << "_______________________" << endl;
            for (int i = 0; i < b.getClientes().size(); i++) {
                cout << b.getClientes()[i].getName() << endl;
                cout << b.getClientes()[i].getNif() << endl;
                cout << b.getClientes()[i].getMorada().getRua() << ", " << b.getClientes()[i].getMorada().getLocalidade() << ", " << b.getClientes()[i].getMorada().getNumero() << endl;
                cout << b.getClientes()[i].getBase().getConselho() << endl;
                cout << ":::::" << endl;
            }
        }
        if (base == 2) {
