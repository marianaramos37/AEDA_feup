...
void Base::removeAdmin(Funcionario f) {
    ...
    if(a==true) {
        ...
        for (int i = 0; i < funcionarios.size() - 1; i++) {
            ...
            //cout<<funcionarios[i]->getNome()<<endl;
            //cout<<funcionarios[i]->getTipoDeFuncionario()<<endl;
            // cout<<(funcionarios[i]->getTipoDeFuncionario() == "Entregador")<<endl;
            // cout<<funcionarios[i]->getTipoDeFuncionario()<<"aaaaaaaa"<<endl;
            // cout<<i<<endl;
            if (funcionarios[i]->getTipoDeFuncionario() == "Administrador") {
